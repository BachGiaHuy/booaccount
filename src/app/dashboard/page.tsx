    ...
    <main className="pt-24 md:pt-32 pb-24 max-w-7xl mx-auto px-6">
      {showNewOrderSuccess && (
        <div className="mb-8 p-6 rounded-3xl bg-primary/10 border border-primary/20 flex items-center gap-4 text-primary animate-in fade-in slide-in-from-top-4 duration-500">
          ...
          <div>
            ...
            <p className="text-xs opacity-80">Tài khoản của bạn đã được gửi qua email và hiển thị bên dưới.</p>
          </div>
        </div>
      )}
      ...
      <div className="flex flex-col md:flex-row justify-between items-start gap-8 mb-12">
        <div>
          ...
          <p className="text-muted-foreground">Chào mừng trở lại! Quản lý các dịch vụ và lịch sử mua hàng của bạn.</p>
        </div>
          ...
          <div className="p-6 rounded-3xl bg-white/5 border border-white/10">
            ...
            <div className="space-y-4">
              <div className="flex justify-between text-sm">
                ...
                <span className="text-white font-bold">{orders.length > 0 ? (orders.length * 50000).toLocaleString() : "0"}đ</span>
              </div>
              <div className="flex justify-between text-sm">
                <span className="text-muted-foreground">Tích điểm:</span>
                <span className="text-primary font-bold">{orders.length * 10} pts</span>
              </div>
            </div>
          </div>
